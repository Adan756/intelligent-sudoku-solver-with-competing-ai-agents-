...
!\[Start Screen](screenshots/start\_screen.png)



!\[Difficulty Selection](screenshots/difficulty\_screen.png)



!\[VS Screen](screenshots/versus\_screen.png)



!\[Game Screen](screenshots/game\_screen.png)
...
│   ├── bfs\_agent.py           # BFS solving agent

│   └── dfs\_agent.py           # DFS solving agent with backtracking

│

├── gui/

│   ├── start\_screen.py        # Title screen

│   ├── difficulty\_screen.py   # Difficulty selection screen

│   ├── versus\_screen.py       # VS intro screen

│   ├── game\_screen.py         # Main game loop and animation

│   └── grid\_ui.py             # Sudoku grid renderer
